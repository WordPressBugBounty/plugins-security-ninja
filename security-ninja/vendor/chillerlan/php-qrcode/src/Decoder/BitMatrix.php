...
use WPSecurityNinja\Plugin\chillerlan\QRCode\Common\{EccLevel, MaskPattern, Version};
use WPSecurityNinja\Plugin\chillerlan\QRCode\Data\{QRCodeDataException, QRMatrix};
