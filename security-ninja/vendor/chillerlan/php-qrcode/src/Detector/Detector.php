...
namespace WPSecurityNinja\Plugin\chillerlan\QRCode\Detector;

use WPSecurityNinja\Plugin\chillerlan\QRCode\Common\{LuminanceSourceInterface, Version};
use WPSecurityNinja\Plugin\chillerlan\QRCode\Decoder\{Binarizer, BitMatrix};
